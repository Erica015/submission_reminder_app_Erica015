...
echo "erica, Shell Navigation, not submitted" >> submission_reminder_app/assets/submissions.txt
...
echo "eloi, Shell Navigation, submitted" >> submission_reminder_app/assets/submissions.txt
